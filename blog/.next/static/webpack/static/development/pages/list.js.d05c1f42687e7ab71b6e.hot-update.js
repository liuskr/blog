...
var myList = function myList(props) {
  ...
  return __jsx("div", {
  ...
  }, Array.isArray(ilist) && arr.length === 0 ? '' : ilist[0].typeName))), __jsx(antd_lib_list__WEBPACK_IMPORTED_MODULE_5___default.a, {
    header: __jsx("div", {
    ...
    }, Array.isArray(ilist) && arr.length === 0 ? '' : ilist[0].typeName),
    dataSource: ilist,
    itemLayout: "vertical",
    split: true,
...
//# sourceMappingURL=list.js.d05c1f42687e7ab71b6e.hot-update.js.map