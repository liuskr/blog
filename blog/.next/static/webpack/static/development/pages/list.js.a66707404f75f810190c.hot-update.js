...
var myList = function myList(props) {
  ...
  return __jsx("div", {
  ...
  }, ilist.length >= 0 ? ilist[0].typeName : 'node'))), __jsx(antd_lib_list__WEBPACK_IMPORTED_MODULE_5___default.a, {
    header: __jsx("div", {
    ...
    }, ilist.length < 0 ? ilist[0].typeName : 'node'),
    dataSource: ilist,
    itemLayout: "vertical",
    split: true,
...
//# sourceMappingURL=list.js.a66707404f75f810190c.hot-update.js.map