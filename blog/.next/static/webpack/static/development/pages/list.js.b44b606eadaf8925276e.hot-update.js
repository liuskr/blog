...
var myList = function myList(props) {
  ...
  return __jsx("div", {
  ...
  }, props.data[0].typeName ? rops.data[0].typeName : ''))), __jsx(antd_lib_list__WEBPACK_IMPORTED_MODULE_5___default.a, {
    header: __jsx("div", {
    ...
    }, props.data[0].typeName ? rops.data[0].typeName : ''),
    dataSource: ilist,
    itemLayout: "vertical",
    split: true,
...
//# sourceMappingURL=list.js.b44b606eadaf8925276e.hot-update.js.map