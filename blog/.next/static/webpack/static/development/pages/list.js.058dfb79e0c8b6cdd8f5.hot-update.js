...
var myList = function myList(props) {
  ...
  return __jsx("div", {
  ...
  }, Array.isArray(ilist) && ilist.length === 0 ? '博主在偷懒~' : ilist[0].typeName))), __jsx(antd_lib_list__WEBPACK_IMPORTED_MODULE_5___default.a, {
    header: __jsx("div", {
    ...
    }, Array.isArray(ilist) && ilist.length === 0 ? '博主在偷懒~' : ilist[0].typeName),
    dataSource: ilist,
    itemLayout: "vertical",
    split: true,
...
//# sourceMappingURL=list.js.058dfb79e0c8b6cdd8f5.hot-update.js.map