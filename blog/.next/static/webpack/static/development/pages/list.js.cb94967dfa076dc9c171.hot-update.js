...
var myList = function myList(props) {
  ...
  return __jsx("div", {
  ...
  }, Array.isArray(ilist) && ilist.length === 0 ? 'Node' : ilist[0].typeName))), __jsx(antd_lib_list__WEBPACK_IMPORTED_MODULE_5___default.a, {
    header: __jsx("div", {
    ...
    }, Array.isArray(ilist) && ilist.length === 0 ? 'Node' : ilist[0].typeName),
    dataSource: ilist,
    itemLayout: "vertical",
    split: true,
...
//# sourceMappingURL=list.js.cb94967dfa076dc9c171.hot-update.js.map